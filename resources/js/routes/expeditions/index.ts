...
/**
* @see \App\Http\Controllers\ExpeditionController::status
 * @see app/Http/Controllers/ExpeditionController.php:224
 * @route '/expeditions/{expedition}/status'
 */
export const status = (args: { expedition: number | { id: number } } | [expedition: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'put'> => ({
 ...
 * @route '/expeditions/{expedition}/status'
 */
status.url = (args: { expedition: number | { id: number } } | [expedition: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { expedition: args }
    }
 ...
 * @route '/expeditions/{expedition}/status'
 */
status.put = (args: { expedition: number | { id: number } } | [expedition: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: status.url(args, options),
    method: 'put',
})
const expeditions = {
