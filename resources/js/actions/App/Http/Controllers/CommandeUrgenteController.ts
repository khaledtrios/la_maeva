...
/**
* @see \App\Http\Controllers\CommandeUrgenteController::updateStatus
 * @see app/Http/Controllers/CommandeUrgenteController.php:168
 * @route '/commandes-urgentes/{commande}/status'
 */
export const updateStatus = (args: { commande: string | number } | [commande: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/commandes-urgentes/{commande}/status'
 */
updateStatus.url = (args: { commande: string | number } | [commande: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { commande: args }
    }
 ...
 * @route '/commandes-urgentes/{commande}/status'
 */
updateStatus.post = (args: { commande: string | number } | [commande: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: updateStatus.url(args, options),
    method: 'post',
})
...
const CommandeUrgenteController = { index, create, store, take, updateStatus, createBl, show }

export default CommandeUrgenteController